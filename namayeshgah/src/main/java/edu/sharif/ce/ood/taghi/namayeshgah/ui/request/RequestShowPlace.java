...
public class RequestShowPlace extends BaseUI implements ItemListener {
	...
	public RequestShowPlace() {
		...
		panel.setLayout(new MigLayout("", "[][grow][50px:n:100px][]", "[grow][][][][][][grow][][]"));
		
		SelecTshowPlaceCombo<ShowPlaceBean> selecTshowPlaceCombo = new SelecTshowPlaceCombo<ShowPlaceBean>(ShowPlaceCatalog.getInstance().getAllShowPlaces(), this);
